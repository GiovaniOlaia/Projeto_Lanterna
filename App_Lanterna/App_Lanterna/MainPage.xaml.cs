...
namespace App_Lanterna
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("App_Lanterna.Image.Button_OFF.jpg");
        ...
        private async void Carrega_Informacoes_Bateria()
        {
            try
            {
                ...
                {
                    lbl_Bateria_Fraca.Text = "As informações sobre a  bateria não estão dísponiveis :( ";
                }
            }
            catch (Exception ex)
            {
                await DisplayAlert("Ocorreu umk erro: \n ", ex.Message, "OK");
            }
        }
            ...
            try
            {
                ...
                switch (e.Status)
                {
                    ...
                    case Plugin.Battery.Abstractions.BatteryStatus.NotCharging:
                        lbl_status.Text = "Não está carregando";
                        break;
                ...
                switch (e.PowerSource)
                {
                    ...
                    case Plugin.Battery.Abstractions.PowerSource.Usb:
                        lbl_fonte_carregamento.Text = "Cabo USB";
                        break;

                    case Plugin.Battery.Abstractions.PowerSource.Wireless:
                        lbl_fonte_carregamento.Text = "Carregador Wireless (sem-fio)";
                        break;
        ...
        private async void BtnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (!lanterna_ligada)
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("App_Lanterna.Image.Button_ON.jpg");
